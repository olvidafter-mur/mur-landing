...
export const THEME = {
  ...
  dark: {
    ...
    surface: 'border-brand-cream/15 bg-brand-blue-panel/85 shadow-soft-dark backdrop-blur-sm',
    softSurface: 'border-brand-cream/15 bg-brand-blue-soft/80',
    insetSurface: 'border-brand-cream/15 bg-brand-cream/[0.06]',
    warmSurface: 'border-brand-amber/35 bg-brand-amber/[0.12]',
    tealSurface: 'border-brand-teal/35 bg-brand-teal/[0.14]',
    greenSurface: 'border-brand-green/35 bg-brand-green/[0.14]',
