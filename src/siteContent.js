...
export const THEME = {
  ...
  dark: {
    marketingPage: 'bg-brand-night text-brand-paper',
    legalPage: 'bg-brand-night text-brand-paper',
    nav: 'border-brand-paper/[0.12] bg-brand-night/90 backdrop-blur-xl',
    navNarrow: 'border-brand-paper/[0.12] bg-brand-night/95 backdrop-blur-xl',
    navText: 'text-brand-paper/75 hover:text-white',
    navTextNarrow: 'text-brand-paper/75 hover:text-white',
    navLink:
    ...
    border: 'border-brand-paper/[0.12]',
    surface: 'border-brand-paper/[0.12] bg-white/[0.07] shadow-soft-dark backdrop-blur-sm',
    softSurface: 'border-brand-paper/[0.12] bg-white/[0.05]',
    insetSurface: 'border-brand-paper/[0.12] bg-white/[0.07]',
    warmSurface: 'border-brand-amber/25 bg-brand-amber/10',
    tealSurface: 'border-brand-teal/25 bg-brand-teal/10',
    greenSurface: 'border-brand-green/25 bg-brand-green/10',
    legalBorder: 'border-brand-paper/[0.12]',
    legalMuted: 'text-brand-paper/[0.72]',
    legalSoft: 'border-brand-paper/[0.12] bg-white/[0.07] text-brand-paper',
    primaryButton:
      'bg-brand-paper text-brand-ink hover:bg-white focus-visible:ring-brand-amber/80',
    secondaryButton:
      'border-brand-paper/15 bg-white/[0.07] text-brand-paper hover:border-brand-amber/50 hover:bg-white/[0.11]',
    activeControl: 'border-brand-paper bg-brand-paper text-brand-ink',
    inactiveControl: 'border-transparent text-brand-paper/70 hover:text-white',
    legalDivide: 'divide-brand-paper/[0.12]',
  },
}
