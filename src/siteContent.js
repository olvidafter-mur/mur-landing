...
export const THEME = {
  light: {
    ...
    nav: 'border-brand-ink/10 bg-white/95 backdrop-blur-xl',
    ...
    surface: 'border-brand-ink/10 bg-white shadow-sm',
...
export const CONTENT = {
  es: {
    ...
    nav: {
      ...
      algorithmPaper: 'Paper del algoritmo',
    ...
    home: {
      ...
      productTitle: 'Todo lo cercano, sin ruido.',
      productBody:
        'Un feed para enterarte rápido: alertas, mascotas, promos y preguntas del barrio.',
      stepsLabel: 'Cómo funciona',
      stepsTitle: 'Mapa y filtros claros.',
      waitlistLabel: 'Lista de espera',
      waitlistTitle: 'Probá MUR antes que todos.',
      waitlistBody:
        'Estamos abriendo por zonas. Sumate y te avisamos cuando tu barrio entre en la primera tanda.',
    ...
    productPoints: [
      'Feed ordenado por cercanía',
      'Mapa para ubicar rápido',
      'Filtros por tipo de aviso',
    ],
    steps: [
      {
        title: 'Mirá qué pasa',
        body: 'Un vistazo para entender tu zona.',
      },
      {
        title: 'Filtrá el ruido',
        body: 'Mascotas, alertas, comercios o ayuda.',
      },
      {
        title: 'Respondé con contexto',
        body: 'Comentarios y datos útiles sin salir de la app.',
      },
    ],
    faq: [
      {
  ...
  en: {
    ...
    nav: {
      ...
      waitlist: 'Waitlist',
      algorithmPaper: 'Algorithm paper',
    ...
    home: {
      ...
      productTitle: 'Everything nearby, without the noise.',
      productBody:
        'A fast feed for alerts, pets, promos, and neighborhood questions.',
      stepsLabel: 'How it works',
      stepsTitle: 'Clear map and filters.',
      waitlistLabel: 'Waitlist',
      waitlistTitle: 'Try MUR before everyone else.',
      waitlistBody:
        'We are opening area by area. Join and we will tell you when your neighborhood enters the first wave.',
      faqLabel: 'FAQ',
    ...
    productPoints: [
      'Feed ordered by proximity',
      'Map for quick context',
      'Filters by alert type',
    ],
    steps: [
      {
        title: 'See what is happening',
        body: 'A quick read on your area.',
      },
      {
        title: 'Filter the noise',
        body: 'Pets, alerts, shops, or neighbor help.',
      },
      {
        title: 'Reply with context',
        body: 'Useful comments without leaving the app.',
      },
    ],
    faq: [
      {
